...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        /*
         * Check the condition of subtract: the top number should greater than
         * the bottom number
         */
        ...
        /*
         * Check the condition of division: avoid divide by zero
         */
        if (bottomNum.isZero()) {
        ...
        /*
         * Check the condition of the power: avoid the power value exceed the
         * int limit
         */
        ...
        /*
         * Check the condition of root: ensure the root is greater than two and
         * not exceed the int limit
         */
    ...
    public void processDivideEvent() {
         ...
         * Update model in response to this event
         */
        NaturalNumber storeRemainder = topNum.divide(bottomNum);
        bottomNum.transferFrom(topNum);
        topNum.transferFrom(storeRemainder);
        /*
         * Update view to reflect changes in model
         */
        updateViewToMatchModel(this.model, this.view);
