...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        int buttonNum = 0;
        while (buttonNum < DIGIT_BUTTONS) {
            String toStringNum = String.valueOf(buttonNum);
            this.bDigits[buttonNum] = new JButton(toStringNum);
            buttonNum++;
        }
         ...
         */
        int firstRow = 7;
        while (firstRow < DIGIT_BUTTONS) {
            buttonPanel.add(this.bDigits[firstRow]);
            firstRow++;
        }
        firstRow = 7;
        ...
        while (secondRow < firstRow) {
            buttonPanel.add(this.bDigits[secondRow]);
            secondRow++;
        }
        secondRow = 4;
        ...
        int thirdRow = 1;
        while (thirdRow < secondRow) {
            buttonPanel.add(this.bDigits[thirdRow]);
            thirdRow++;
        }
        ...
        int buttonNum2 = 0;
        while (buttonNum2 < DIGIT_BUTTONS) {
            this.bDigits[buttonNum2].addActionListener(this);
            buttonNum2++;
        }
